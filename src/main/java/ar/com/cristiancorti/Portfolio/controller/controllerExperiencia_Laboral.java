...
public class controllerExperiencia_Laboral {
    ...
    @DeleteMapping("/delete/experiencia_laboral/{id}")
    public void borrarIdExperiencia_Laboral (@PathVariable Long id) {
       iexperiencia_laboralsvc.borrarIdExperiencia_Laboral(id);
    }
